...
<link rel="stylesheet" href="''' + url_for('static', filename='lab1.css') + '''">
    ...
    <body>
        ...
        <h1>web-сервер на flask</h1>
        Меню
        <div><a href ="/lab2/">Лабораторная работа 2</a></li></div>
        <div><a href ="/lab3/">Лабораторная работа 3</a></li></div>
        <div><a href ="/lab4/">Лабораторная работа 4</a></li></div>
        <div><a href ="/lab5/">Лабораторная работа 5</a></li></div>
        <div><a href ="/lab6/">Лабораторная работа 6</a></li></div>
        <div><a href ="/lab7/">Лабораторная работа 7</a></li></div>
        <div><a href ="/lab8/">Лабораторная работа 8</a></li></div>
        <footer>
            &copy; Лабаскина София, Переладова Алёна, ФБИ-12, 3 курс, 2023
        </footer>
    </body>
